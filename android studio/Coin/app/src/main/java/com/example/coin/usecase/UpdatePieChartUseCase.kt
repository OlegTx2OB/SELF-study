...
class UpdatePieChartUseCase(private val c: Context) {

    fun updatePieChartSectionData(notes: List<Note>?, isIncomes: Boolean, maxCategoriesCount: Int): Pair<PieData, String> {
        ...
        return if (notes == null) {
            ...
            val (entries, descriptionStr) = createPieChartEntries(sortedTopCategoriesPairs,  maxCategoriesCount)
    ...
    private fun createPieChartEntries(pairs: List<Pair<String, Pair<Float, Int>>>,  maxCategoriesCount: Int): Pair<List<PieEntry>, String> {
